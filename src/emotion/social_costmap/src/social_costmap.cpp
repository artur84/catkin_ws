...
#include <social_costmap/SocialCostmapConfig.h>

using namespace std;

namespace social_costmap{
  SocialCostmap::SocialCostmap(unsigned int cells_size_x, unsigned int cells_size_y,
  ...
  void SocialCostmap::reconfigure(SocialCostmapConfig &config, const SocialCostmapConfig &last_config) {
  ...
  void SocialCostmap::finishConfiguration(social_costmap::SocialCostmapConfig &config) {
  }

  void SocialCostmap::replaceFullMap(double win_origin_x, double win_origin_y,
  ...
  void SocialCostmap::replaceStaticMapWindow(double win_origin_x, double win_origin_y,
                                         unsigned int data_size_x, unsigned int data_size_y,
                                         const std::vector<unsigned char>& static_data){
  ...
  void SocialCostmap::reshapeStaticMap(double win_origin_x, double win_origin_y,
  ...
  void SocialCostmap::updateStaticMapWindow(double win_origin_x, double win_origin_y,
                                      unsigned int data_size_x, unsigned int data_size_y,
                                      const std::vector<unsigned char>& static_data){
  ...
  void SocialCostmap::deleteKernels(){
  ...
  void SocialCostmap::initMaps(unsigned int size_x, unsigned int size_y){
  ...
  void SocialCostmap::copyKernels(const SocialCostmap& map, unsigned int cell_inflation_radius){
  ...
  void SocialCostmap::copyCostmapWindow(const SocialCostmap& map, double win_origin_x, double win_origin_y, double win_size_x, double win_size_y){
  ...
  SocialCostmap& SocialCostmap::operator=(const SocialCostmap& map) {
  ...
  SocialCostmap::SocialCostmap(const SocialCostmap& map) : static_map_(NULL), costmap_(NULL), markers_(NULL), cached_costs_(NULL), cached_distances_(NULL) {
    *this = map;
  }

  //just initialize everything to NULL by default
  SocialCostmap::SocialCostmap() : size_x_(0), size_y_(0), resolution_(0.0), origin_x_(0.0), origin_y_(0.0), static_map_(NULL),
  ...
  unsigned int SocialCostmap::cellDistance(double world_dist){
    double cells_dist = max(0.0, ceil(world_dist / resolution_));
    return (unsigned int) cells_dist;
  }

  const unsigned char* SocialCostmap::getCharMap() const {
    return costmap_;
  }

  unsigned char SocialCostmap::getCost(unsigned int mx, unsigned int my) const {
    ROS_ASSERT_MSG(mx < size_x_ && my < size_y_, "You cannot get the cost of a cell that is outside the bounds of the costmap");
    return costmap_[getIndex(mx, my)];
  }

  void SocialCostmap::setCost(unsigned int mx, unsigned int my, unsigned char cost) {
    ROS_ASSERT_MSG(mx < size_x_ && my < size_y_, "You cannot set the cost of a cell that is outside the bounds of the costmap");
    costmap_[getIndex(mx, my)] = cost;
  }

  void SocialCostmap::mapToWorld(unsigned int mx, unsigned int my, double& wx, double& wy) const {
    wx = origin_x_ + (mx + 0.5) * resolution_;
    wy = origin_y_ + (my + 0.5) * resolution_;
  }

  bool SocialCostmap::worldToMap(double wx, double wy, unsigned int& mx, unsigned int& my) const {
  ...
  void SocialCostmap::worldToMapNoBounds(double wx, double wy, int& mx, int& my) const {
    mx = (int) ((wx - origin_x_) / resolution_);
    my = (int) ((wy - origin_y_) / resolution_);
  }

  void SocialCostmap::resetMapOutsideWindow(double wx, double wy, double w_size_x, double w_size_y){
  ...
  void SocialCostmap::updateWorld(double robot_x, double robot_y,
  ...
  void SocialCostmap::reinflateWindow(double wx, double wy, double w_size_x, double w_size_y, bool clear){
  ...
  void SocialCostmap::updateObstacles(const vector<Observation>& observations, priority_queue<CellData>& inflation_queue){
  ...
  void SocialCostmap::inflateObstacles(priority_queue<CellData>& inflation_queue){
  ...
  void SocialCostmap::raytraceFreespace(const std::vector<Observation>& clearing_observations){
    for(unsigned int i = 0; i < clearing_observations.size(); ++i){
      raytraceFreespace(clearing_observations[i]);
    }
  }

  void SocialCostmap::raytraceFreespace(const Observation& clearing_observation){
  ...
  void SocialCostmap::clearNonLethal(double wx, double wy, double w_size_x, double w_size_y, bool clear_no_info){
  ...
  void SocialCostmap::resetInflationWindow(double wx, double wy, double w_size_x, double w_size_y,
  ...
  void SocialCostmap::computeCaches() {
  ...
  void SocialCostmap::updateOrigin(double new_origin_x, double new_origin_y){
  ...
  bool SocialCostmap::setConvexPolygonCost(const std::vector<geometry_msgs::Point>& polygon, unsigned char cost_value) {
  ...
  void SocialCostmap::polygonOutlineCells(const std::vector<MapLocation>& polygon, std::vector<MapLocation>& polygon_cells){
  ...
  void SocialCostmap::convexFillCells(const std::vector<MapLocation>& polygon, std::vector<MapLocation>& polygon_cells){
  ...
  unsigned int SocialCostmap::getSizeInCellsX() const{
    return size_x_;
  }

  unsigned int SocialCostmap::getSizeInCellsY() const{
    return size_y_;
  }

  double SocialCostmap::getSizeInMetersX() const{
    return (size_x_ - 1 + 0.5) * resolution_;
  }

  double SocialCostmap::getSizeInMetersY() const{
    return (size_y_ - 1 + 0.5) * resolution_;
  }

  double SocialCostmap::getOriginX() const{
    return origin_x_;
  }

  double SocialCostmap::getOriginY() const{
    return origin_y_;
  }

  double SocialCostmap::getResolution() const{
    return resolution_;
  }

  bool SocialCostmap::isCircumscribedCell(unsigned int x, unsigned int y) const {
  ...
  void SocialCostmap::saveMap(std::string file_name){
