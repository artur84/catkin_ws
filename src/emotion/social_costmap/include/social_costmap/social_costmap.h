#ifndef COSTMAP_SOCIAL_COSTMAP_H_
#define COSTMAP_SOCIAL_COSTMAP_H_

#include <vector>
#include <queue>
#include <cmath>
#include <social_costmap/observation.h>
#include <social_costmap/cell_data.h>
#include <social_costmap/cost_values.h>
...
namespace social_costmap {
  ...
  class SocialCostmap {
    ...
    public:
       ...
       */
      SocialCostmap(unsigned int cells_size_x, unsigned int cells_size_y,
       ...
       */
      SocialCostmap(const SocialCostmap& map);
       ...
       */
      SocialCostmap& operator=(const SocialCostmap& map);
       ...
       */
      void copyCostmapWindow(const SocialCostmap& map, double win_origin_x, double win_origin_y, double win_size_x, double win_size_y);
       ...
       * @brief  Destructor
       */
      virtual ~SocialCostmap();

      void reconfigure(social_costmap::SocialCostmapConfig &config, const social_costmap::SocialCostmapConfig& last_config);

      virtual void finishConfiguration(social_costmap::SocialCostmapConfig &config);
    ...
    protected:
       ...
       */
      void copyKernels(const SocialCostmap& map, unsigned int cell_inflation_radius);
    ...
    protected:
      ...
      class PolygonOutlineCells {
        public:
          PolygonOutlineCells(const SocialCostmap& costmap, const unsigned char* char_map, std::vector<MapLocation>& cells)
