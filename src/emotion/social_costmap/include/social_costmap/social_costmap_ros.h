#ifndef COSTMAP_SOCIAL_COSTMAP_ROS_H_
#define COSTMAP_SOCIAL_COSTMAP_ROS_H_

#include <ros/ros.h>

#include <social_costmap/social_costmap.h>
#include <social_costmap/social_costmap_publisher.h>
#include <social_costmap/observation_buffer.h>
...
namespace social_costmap {
  ...
  class SocialCostmapROS {
    public:
       ...
       */
      SocialCostmapROS(std::string name, tf::TransformListener& tf);
       ...
       */
      void getCostmapCopy(SocialCostmap& costmap) const;
       ...
       * @param costmap A reference to the map to populate
       */
      void getCostmapWindowCopy(double win_size_x, double win_size_y, SocialCostmap& costmap) const;
       ...
       * @param costmap A reference to the map to populate
       */
      void getCostmapWindowCopy(double win_center_x, double win_center_y, double win_size_x, double win_size_y, SocialCostmap& costmap) const;
    ...
    private:
       ...
       */
      void reconfigureCB(social_costmap::SocialCostmapConfig &config, uint32_t level);
      ...
      SocialCostmap* costmap_; ///< @brief The underlying costmap to update
      ...
      SocialCostmapPublisher* costmap_publisher_;
      ...
      dynamic_reconfigure::Server<social_costmap::SocialCostmapConfig> *dsrv_;
      boost::mutex map_update_mutex_;
      boost::recursive_mutex configuration_mutex_;
      social_costmap::SocialCostmapConfig last_config_;
      social_costmap::SocialCostmapConfig maptype_config_;
      social_costmap::SocialCostmapConfig default_config_;
      ros::Timer timer_;
