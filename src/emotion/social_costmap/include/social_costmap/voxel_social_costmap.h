#ifndef COSTMAP_VOXEL_SOCIAL_COSTMAP_H_
#define COSTMAP_VOXEL_SOCIAL_COSTMAP_H_
...
namespace social_costmap {
  ...
  class VoxelSocialCostmap : public SocialCostmap {
    public:
       ...
       */
      VoxelSocialCostmap(unsigned int cells_size_x, unsigned int cells_size_y, unsigned int cells_size_z,
      ...
      VoxelSocialCostmap(social_costmap::SocialCostmap& costmap, 
    ...
    private:
      ...
      void finishConfiguration(social_costmap::SocialCostmapConfig &config);
