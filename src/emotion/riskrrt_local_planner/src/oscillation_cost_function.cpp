#include <riskrrt_local_planner/oscillation_cost_function.h>
...
void OscillationCostFunction::updateOscillationFlags(Eigen::Vector3f pos, riskrrt_local_planner::Trajectory* traj, double min_vel_trans) {
  if (traj->cost_ >= 0) {
...
bool OscillationCostFunction::setOscillationFlags(riskrrt_local_planner::Trajectory* t, double min_vel_trans) {
  bool flag_set = false;
