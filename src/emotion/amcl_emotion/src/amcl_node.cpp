...
class AmclNode
{
  ...
  private:
    ...
    double d_thresh_, a_thresh_, t_thresh_;
        ...
        first_reconfigure_call_(true)
{
  ...
  private_nh_.param("update_min_t", t_thresh_, 1.);
...
AmclNode::laserReceived(const sensor_msgs::LaserScanConstPtr& laser_scan)
{
  ...
  if(pf_init_)
  {
    ...
    ros::Duration dt = last_laser_received_ts_ - last_update_time;
    ...
    if(update)
    {
      last_update_time = last_laser_received_ts_;
